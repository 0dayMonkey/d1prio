...
namespace OpenMarketingApi.Models.Player.Player
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayerPOST : IServiceAction
    {
        /// <summary>
        /// if not specified, then the system will generate and assign a newly generated ID
        /// </summary>
        /// <value>if not specified, then the system will generate and assign a newly generated ID</value>
